  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        {/* Books image */}
        <img
          src="/src/assets/HeroImages/Books.png"
          alt="Books"
        ...
        {/* Student image */}
        <img
          src="/src/assets/HeroImages/Man.png"
          alt="Coding Student"
      ...
      <button
        ...
        className="absolute bottom-2 animate-bounce flex flex-col items-center gap-2 text-white/70 hover:text-white transition sm:bottom-2"
      >
